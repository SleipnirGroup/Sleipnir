...
class CurrentManager {
 public:
  ...
  ///
  /// @param current_tolerances The relative current tolerance of each
  ///     subsystem.
 ...
 private:
  ...
  slp::VariableMatrix<double> m_desired_currents;
  slp::VariableMatrix<double> m_allocated_currents;
};
