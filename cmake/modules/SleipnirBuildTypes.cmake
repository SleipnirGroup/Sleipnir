macro(sleipnir_add_build_type allowedBuildTypes buildTypeName cFlags cxxFlags exeLinkerFlags sharedLinkerFlags)
  ...
  set(CMAKE_C_FLAGS_${buildTypeNameUpper}
      ${cFlags} CACHE STRING
      "Flags used by the C compiler for ${buildTypeName} build type or configuration." FORCE)
  set(CMAKE_CXX_FLAGS_${buildTypeNameUpper}
      ${cxxFlags} CACHE STRING
      "Flags used by the C++ compiler for ${buildTypeName} build type or configuration." FORCE)
  set(CMAKE_EXE_LINKER_FLAGS_${buildTypeNameUpper}
      ${exeLinkerFlags} CACHE STRING
      "Linker flags to be used to create executables for ${buildTypeName} build type." FORCE)
  set(CMAKE_SHARED_LINKER_FLAGS_${buildTypeNameUpper}
      ${sharedLinkerFlags} CACHE STRING
      "Linker lags to be used to create shared libraries for ${buildTypeName} build type." FORCE)
endmacro()
