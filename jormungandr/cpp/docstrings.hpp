...
static const char *__doc_sleipnir_DynamicsType_DISCRETE = R"doc(The dynamics are a function in the form xₖ₊₁ = f(t, xₖ, uₖ).)doc";

static const char *__doc_sleipnir_DynamicsType_EXPLICIT_ODE = R"doc(The dynamics are a function in the form dx/dt = f(t, x, u).)doc";
...
static const char *__doc_sleipnir_ExpressionType_CONSTANT = R"doc(The expression is a constant.)doc";

static const char *__doc_sleipnir_ExpressionType_LINEAR = R"doc(The expression is composed of linear and lower-order operators.)doc";

static const char *__doc_sleipnir_ExpressionType_NONE = R"doc(There is no expression.)doc";

static const char *__doc_sleipnir_ExpressionType_NONLINEAR = R"doc(The expression is composed of nonlinear and lower-order operators.)doc";

static const char *__doc_sleipnir_ExpressionType_QUADRATIC = R"doc(The expression is composed of quadratic and lower-order operators.)doc";
...
static const char *__doc_sleipnir_Gradient_get_profilers =
...
static const char *__doc_sleipnir_Hessian_get_profilers =
...
static const char *__doc_sleipnir_Jacobian_get_profilers =
R"doc(Returns the profilers.
...
static const char *__doc_sleipnir_Jacobian_m_cached_triplets = R"doc()doc";

static const char *__doc_sleipnir_Jacobian_m_graphs = R"doc()doc";

static const char *__doc_sleipnir_Jacobian_m_nonlinear_rows = R"doc()doc";
...
static const char *__doc_sleipnir_OCPSolver_constrain_direct_collocation = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_constrain_direct_transcription = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_constrain_final_state =
R"doc(Utility function to constrain the final state.

Parameter ``final_state``:
    the final state to constrain to.)doc";

static const char *__doc_sleipnir_OCPSolver_constrain_initial_state =
R"doc(Utility function to constrain the initial state.

Parameter ``initial_state``:
    the initial state to constrain to.)doc";

static const char *__doc_sleipnir_OCPSolver_constrain_single_shooting = R"doc()doc";
...
static const char *__doc_sleipnir_OCPSolver_final_state =
R"doc(Convenience function to get the final state in the trajectory.

Returns:
    The final state of the trajectory.)doc";

static const char *__doc_sleipnir_OCPSolver_for_each_step =
R"doc(Set the constraint evaluation function. This function is called
`num_steps+1` times, with the corresponding state and input
VariableMatrices.
...
static const char *__doc_sleipnir_OCPSolver_initial_state =
...
static const char *__doc_sleipnir_OCPSolver_m_dynamics_function = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_m_dynamics_type = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_m_num_inputs = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_m_num_states = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_m_num_steps = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_m_timestep_method = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_m_transcription_method = R"doc()doc";

static const char *__doc_sleipnir_OCPSolver_set_lower_input_bound =
...
static const char *__doc_sleipnir_OCPSolver_set_upper_input_bound =
...
static const char *__doc_sleipnir_OptimizationProblem_add_callback =
...
static const char *__doc_sleipnir_OptimizationProblem_add_callback_2 =
R"doc(Adds a callback to be called at each solver iteration.
...
static const char *__doc_sleipnir_OptimizationProblem_clear_callbacks = R"doc(Clears the registered callbacks.)doc";

static const char *__doc_sleipnir_OptimizationProblem_decision_variable =
R"doc(Create a decision variable in the optimization problem.

Returns:
    A decision variable in the optimization problem.)doc";

static const char *__doc_sleipnir_OptimizationProblem_decision_variable_2 =
...
static const char *__doc_sleipnir_OptimizationProblem_m_decision_variables = R"doc()doc";

static const char *__doc_sleipnir_OptimizationProblem_m_equality_constraints = R"doc()doc";

static const char *__doc_sleipnir_OptimizationProblem_m_f = R"doc()doc";

static const char *__doc_sleipnir_OptimizationProblem_m_inequality_constraints = R"doc()doc";
...
static const char *__doc_sleipnir_OptimizationProblem_subject_to_2 =
R"doc(Tells the solver to solve the problem while satisfying the given
equality constraint.
...
static const char *__doc_sleipnir_OptimizationProblem_subject_to_3 =
R"doc(Tells the solver to solve the problem while satisfying the given
...
static const char *__doc_sleipnir_OptimizationProblem_subject_to_4 =
R"doc(Tells the solver to solve the problem while satisfying the given
inequality constraint.
...
static const char *__doc_sleipnir_OptimizationProblem_symmetric_decision_variable =
...
static const char *__doc_sleipnir_SolverConfig_acceptable_tolerance =
...
static const char *__doc_sleipnir_SolverConfig_diagnostics =
...
static const char *__doc_sleipnir_SolverConfig_feasible_ipm =
...
static const char *__doc_sleipnir_SolverConfig_max_acceptable_iterations =
...
static const char *__doc_sleipnir_SolverExitCondition_CALLBACK_REQUESTED_STOP =
R"doc(The solver returned its solution so far after the user requested a
stop.)doc";

static const char *__doc_sleipnir_SolverExitCondition_DIVERGING_ITERATES =
R"doc(The solver encountered diverging primal iterates xₖ and/or sₖ and gave
up.)doc";

static const char *__doc_sleipnir_SolverExitCondition_FACTORIZATION_FAILED = R"doc(The linear system factorization failed.)doc";

static const char *__doc_sleipnir_SolverExitCondition_LINE_SEARCH_FAILED =
R"doc(The backtracking line search failed, and the problem isn't locally
infeasible.)doc";

static const char *__doc_sleipnir_SolverExitCondition_LOCALLY_INFEASIBLE =
R"doc(The solver determined the problem to be locally infeasible and gave
up.)doc";

static const char *__doc_sleipnir_SolverExitCondition_MAX_ITERATIONS_EXCEEDED =
R"doc(The solver returned its solution so far after exceeding the maximum
number of iterations.)doc";

static const char *__doc_sleipnir_SolverExitCondition_NONFINITE_INITIAL_COST_OR_CONSTRAINTS =
R"doc(The solver encountered nonfinite initial cost or constraints and gave
up.)doc";

static const char *__doc_sleipnir_SolverExitCondition_SOLVED_TO_ACCEPTABLE_TOLERANCE =
R"doc(Solved the problem to an acceptable tolerance, but not the desired
one.)doc";

static const char *__doc_sleipnir_SolverExitCondition_SUCCESS = R"doc(Solved the problem to the desired tolerance.)doc";

static const char *__doc_sleipnir_SolverExitCondition_TIMEOUT =
R"doc(The solver returned its solution so far after exceeding the maximum
elapsed wall clock time.)doc";

static const char *__doc_sleipnir_SolverExitCondition_TOO_FEW_DOFS = R"doc(The solver determined the problem to be overconstrained and gave up.)doc";
...
static const char *__doc_sleipnir_SolverStatus_cost_function_type = R"doc(The cost function type detected by the solver.)doc";

static const char *__doc_sleipnir_SolverStatus_equality_constraint_type = R"doc(The equality constraint type detected by the solver.)doc";

static const char *__doc_sleipnir_SolverStatus_exit_condition = R"doc(The solver's exit condition.)doc";

static const char *__doc_sleipnir_SolverStatus_inequality_constraint_type = R"doc(The inequality constraint type detected by the solver.)doc";

static const char *__doc_sleipnir_TimestepMethod = R"doc(Enum describing the type of system timestep.)doc";

static const char *__doc_sleipnir_TimestepMethod_FIXED = R"doc(The timestep is a fixed constant.)doc";

static const char *__doc_sleipnir_TimestepMethod_VARIABLE = R"doc(The timesteps are allowed to vary as independent decision variables.)doc";

static const char *__doc_sleipnir_TimestepMethod_VARIABLE_SINGLE =
...
static const char *__doc_sleipnir_VariableBlock_cwise_transform =
...
static const char *__doc_sleipnir_VariableBlock_m_col_slice = R"doc()doc";

static const char *__doc_sleipnir_VariableBlock_m_col_slice_length = R"doc()doc";

static const char *__doc_sleipnir_VariableBlock_m_mat = R"doc()doc";

static const char *__doc_sleipnir_VariableBlock_m_row_slice = R"doc()doc";
...
static const char *__doc_sleipnir_VariableBlock_set_value =
...
static const char *__doc_sleipnir_VariableBlock_set_value_2 =
...
static const char *__doc_sleipnir_VariableMatrix_cwise_transform =
R"doc(Transforms the matrix coefficient-wise with an unary operator.
...
static const char *__doc_sleipnir_VariableMatrix_set_value =
...
static const char *__doc_sleipnir_Variable_Variable_2 = R"doc(Constructs an empty Variable.)doc";

static const char *__doc_sleipnir_Variable_Variable_3 = R"doc()doc";

static const char *__doc_sleipnir_Variable_Variable_4 = R"doc()doc";
...
static const char *__doc_sleipnir_Variable_Variable_6 =
R"doc(Constructs a Variable pointing to the specified expression.
...
static const char *__doc_sleipnir_Variable_set_value =
...
static const char *__doc_sleipnir_cwise_reduce =
...
static const char *__doc_sleipnir_detail_AbsExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AbsExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AbsExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_AcosExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AcosExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AcosExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_AdjointExpressionGraph_append_adjoint_triplets =
...
static const char *__doc_sleipnir_detail_AdjointExpressionGraph_generate_gradient_tree =
...
static const char *__doc_sleipnir_detail_AdjointExpressionGraph_m_col_list = R"doc()doc";

static const char *__doc_sleipnir_detail_AdjointExpressionGraph_m_top_list = R"doc()doc";

static const char *__doc_sleipnir_detail_AdjointExpressionGraph_update_values =
...
static const char *__doc_sleipnir_detail_AsinExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AsinExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AsinExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_Atan2Expression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_Atan2Expression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_Atan2Expression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_Atan2Expression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_Atan2Expression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_AtanExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AtanExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_AtanExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_BinaryMinusExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryMinusExpression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryMinusExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryMinusExpression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryMinusExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_BinaryPlusExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryPlusExpression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryPlusExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryPlusExpression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_BinaryPlusExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_ConstExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_CosExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_CosExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_CosExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_CoshExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_CoshExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_CoshExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_DecisionVariableExpression_DecisionVariableExpression_2 =
R"doc(Constructs a nullary expression (an operator with no arguments).

Parameter ``value``:
    The expression value.)doc";

static const char *__doc_sleipnir_detail_DecisionVariableExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_DivExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_DivExpression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_DivExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_DivExpression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_DivExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_ErfExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_ErfExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_ErfExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_ExpExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_ExpExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_ExpExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_Expression_adjoint_expr =
...
static const char *__doc_sleipnir_detail_Expression_grad_expr_l =
...
static const char *__doc_sleipnir_detail_Expression_grad_expr_r =
...
static const char *__doc_sleipnir_detail_Expression_grad_l =
...
static const char *__doc_sleipnir_detail_Expression_grad_r =
...
static const char *__doc_sleipnir_detail_Expression_incoming_edges = R"doc(Counts incoming edges for this node.)doc";

static const char *__doc_sleipnir_detail_Expression_is_constant =
...
static const char *__doc_sleipnir_detail_Expression_ref_count = R"doc(Reference count for intrusive shared pointer.)doc";
...
static const char *__doc_sleipnir_detail_Expression_val = R"doc(The value of the expression node.)doc";
...
static const char *__doc_sleipnir_detail_HypotExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_HypotExpression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_HypotExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_HypotExpression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_HypotExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_Log10Expression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_Log10Expression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_Log10Expression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_LogExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_LogExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_LogExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_MultExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_MultExpression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_MultExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_MultExpression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_MultExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_PowExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_PowExpression_grad_expr_r = R"doc()doc";

static const char *__doc_sleipnir_detail_PowExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_PowExpression_grad_r = R"doc()doc";

static const char *__doc_sleipnir_detail_PowExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_SignExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SignExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SignExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_SinExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SinExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SinExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_SinhExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SinhExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SinhExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_SqrtExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SqrtExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_SqrtExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_TanExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_TanExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_TanExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_TanhExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_TanhExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_TanhExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_UnaryMinusExpression_grad_expr_l = R"doc()doc";

static const char *__doc_sleipnir_detail_UnaryMinusExpression_grad_l = R"doc()doc";

static const char *__doc_sleipnir_detail_UnaryMinusExpression_type = R"doc()doc";
...
static const char *__doc_sleipnir_detail_dec_ref_count =
R"doc(Refcount decrement for intrusive shared pointer.

Parameter ``expr``:
    The shared pointer's managed object.)doc";

static const char *__doc_sleipnir_detail_dec_ref_count_2 =
R"doc(Refcount decrement for intrusive shared pointer.
...
static const char *__doc_sleipnir_detail_inc_ref_count =
R"doc(Refcount increment for intrusive shared pointer.

Parameter ``expr``:
    The shared pointer's managed object.)doc";

static const char *__doc_sleipnir_detail_inc_ref_count_2 =
R"doc(Refcount increment for intrusive shared pointer.
...
static const char *__doc_sleipnir_detail_make_expression_ptr =
...
static const char *__doc_sleipnir_detail_topological_sort =
...
static const char *__doc_sleipnir_detail_update_values =
...
static const char *__doc_sleipnir_interior_point =
...
static const char *__doc_sleipnir_make_constraints =
