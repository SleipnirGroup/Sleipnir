...
WARNING: Sleipnir's cart-pole solve times are inaccurate because the solver doesn't converge properly (see [#46](https://github.com/SleipnirGroup/Sleipnir/issues/46)).
